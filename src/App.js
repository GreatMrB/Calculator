  ...
  return (
    <div className="container">
        <div className='calculator'>
           <div className='screen'>{input !== '' || input === '0' ? (<NumericFormat value = {input}  displayType={'text'} thousandSeparator={true}/>) : (<NumericFormat value={preState}displayType={'text'} thousandSeparator={true}/> ) }
           </div>
